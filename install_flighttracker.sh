#!/bin/bash
# install_flighttracker.sh – Flugtracker Installer v1.9e (robust, root-safe)
...
cp -v index.html platzrunde.gpx logo.png aircraft_db.csv "$WWW_DIR" 2>/dev/null || echo "⚠️ Einige Web-Dateien fehlen – bitte manuell kopieren"
...
# DB-Tabelle anlegen
echo "🛠️ Initialisiere Datenbankstruktur..."
sqlite3 "$DB_DIR/flugdaten.db" <<SQL
